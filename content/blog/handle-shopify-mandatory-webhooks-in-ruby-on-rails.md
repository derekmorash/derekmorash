...
{{< figure src="/blog/handle-shopify-mandatory-webhooks/mandatory-webhooks.png" alt="Shopify app set up mandatory webhooks" attr="Shopify app set up mandatory webhooks" >}}
